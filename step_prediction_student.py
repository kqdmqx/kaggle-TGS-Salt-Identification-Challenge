...
model_name = student_name(student_stage)
print(model_name)
...
def student_prediction_name(i):
    return "./output/035-student-{}.npy".format(i)


prediction = predict_generator_tta(model, x_test)
# prediction = predict_generator_notta(model, x_test)
print(prediction.shape)
np.save(student_prediction_name(student_stage), prediction)
